...
\begin{thebibliography}{1}
 ...
 \bibitem {wiki} Wikipedia {https://en.wikipedia.org/wiki/Internet_of_Things}

 \bibitem {ieee} Chayan Sarkar {DIAT: A Scalable Distributed Architecture for IoT} IEEE INTERNET OF THINGS JOURNAL, VOL. 2, NO. 3, JUNE 2015.
  ...
  \bibitem{pen} Wifi Smart Pen: Sky {\em http://postscapes.com/wifi-smart-pen-sky} 
  \bibitem {bear} Postscapes {http://postscapes.com/home-energy-monitor-hyko-bear}
  \bibitem {shirt} Postscapes {http://postscapes.com/sensor-sleep-shirts-restdevices}
\bibitem {golf} postscapes {http://postscapes.com/golf-glove-sensors-golfsense}
\bibitem {lego} Postscapes {http://postscapes.com/lego-compatible-prototyping-kit-mcookie}
\bibitem {air} Postscapes {http://postscapes.com/wi-fi-indoor-air-quality-sensor-foobot}
